...
static constexpr float PLAYER_SPEED = 4.4f;
static constexpr float NPC_SPEED = 3.6f;

static constexpr unsigned int WORLDWIDTH = 50;
static constexpr unsigned int WORLDHEIGHT = 50;

static constexpr unsigned int NUM_DIRECTIONS = 4;

static constexpr float TILESIZE = 2.0f;

static const vec2 PLAYER_START = vec2(9.0f * TILESIZE, 20.0f * TILESIZE);

static constexpr int NUM_TILETYPES = 13;
static constexpr int NUM_TILEVARIANTS = 34;

static constexpr int NUM_ROWS = 33;
static constexpr int NUM_COLUMNS = 32;

static constexpr int MAPSIZE = 1056;

static constexpr int NUM_LAB_ROWS = 15;
static constexpr int NUM_LAB_COLUMNS = 16;

static constexpr int LABSIZE = 240;

static constexpr int OAKMAXPATHSIZE = 20;
static constexpr int MAXPATHSIZE_TOWN_NPC = 50;

static constexpr int FORESTMAPSIZE = 2112;

static constexpr int NUM_FOREST_ROWS = 44;
static constexpr int NUM_FOREST_COLUMNS = 48;
