...
void Mesh::GeneratePolygon(float radius, int vertices, char r, char g, char b, char a)
{
	...
	{
		x = -(radius * cos(static_cast<float>(i) * (2.0f * PI / static_cast<float>(vertices))));
		y = -(radius * sin(static_cast<float>(i) * (2.0f * PI / static_cast<float>(vertices))));
	...
	x = -(radius * cos(1.0f * (2.0f * PI / static_cast<float>(vertices))));
	y = -(radius * sin(1.0f * (2.0f * PI / static_cast<float>(vertices))));
